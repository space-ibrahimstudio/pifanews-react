...
export function SEO({ title, description, route, thumbSrc, extThumbSrc }) {
  ...
  const thumbnail = extThumbSrc ? extThumbSrc : thumbSrc ? `${domainurl}${thumbSrc}` : `${domainurl}/img/img-01.jpg`;
